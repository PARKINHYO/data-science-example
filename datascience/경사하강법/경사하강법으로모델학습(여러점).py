...
from datascience.mathematics.vector import vector_mean
from datascience.경사하강법.경사하강법으로모델학습 import linear_gradient
from datascience.경사하강법.최저점구하기 import gradient_step
